...
class LicencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create licence" do
    assert_difference("Licence.count") do
      post licences_url, params: { licence: { penalite: @licence.penalite, recupere: @licence.recupere } }
    end
  ...
  test "should update licence" do
    patch licence_url(@licence), params: { licence: { penalite: @licence.penalite, recupere: @licence.recupere } }
