...
class PilotesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pilote" do
    assert_difference("Pilote.count") do
      post pilotes_url, params: { pilote: { division: @pilote.division, ecurie: @pilote.ecurie, nom: @pilote.nom, statut: @pilote.statut } }
    end
  ...
  test "should update pilote" do
    patch pilote_url(@pilote), params: { pilote: { division: @pilote.division, ecurie: @pilote.ecurie, nom: @pilote.nom, statut: @pilote.statut } }
