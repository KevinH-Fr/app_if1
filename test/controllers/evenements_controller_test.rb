...
class EvenementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evenement" do
    assert_difference("Evenement.count") do
      post evenements_url, params: { evenement: { circuit: @evenement.circuit, date: @evenement.date, division: @evenement.division } }
    end
  ...
  test "should update evenement" do
    patch evenement_url(@evenement), params: { evenement: { circuit: @evenement.circuit, date: @evenement.date, division: @evenement.division } }
