...
class SaisonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create saison" do
    assert_difference("Saison.count") do
      post saisons_url, params: { saison: { nom: @saison.nom, numero: @saison.numero, periode: @saison.periode } }
    end
  ...
  test "should update saison" do
    patch saison_url(@saison), params: { saison: { nom: @saison.nom, numero: @saison.numero, periode: @saison.periode } }
